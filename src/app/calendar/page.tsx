        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-9 h-9 rounded-xl border border-border-soft flex items-center justify-center text-charcoal-light hover:bg-white/80 transition-colors disabled:opacity-40 shrink-0"
              title="새로고침"
            >
